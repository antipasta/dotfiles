...
(setq org-books-file "~/org/roam/20210417225225-books.org")
...
(use-package! org-super-agenda
  ...
  (setq org-super-agenda-groups
        '(
         ...
         (:name "DOING"  ; Optionally specify section name
                :todo "DOING")  ; Items that have this TODO keyword
         (:name "Home"  ; Optionally specify section name
                :tag "home")  ; Items that have this TODO keyword
